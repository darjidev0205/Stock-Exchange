...
import { loginUser, googleLogin, devLogin, clearError } from '../store/slices/authSlice';
...
export default function LoginPage() {
  ...
  const handleGoogle = async () => {
    try {
      ...
      // fallback to dev login if Firebase not configured
    }
  };
    ...
    <div className="min-h-screen gradient-bg flex items-center justify-center px-6">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Welcome back, trader</p>
        </div>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs"><span className="px-3 bg-transparent text-gray-500">or continue with</span></div>
        </div>
